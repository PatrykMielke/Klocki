...
<div class="container-sm my-lg-5">
    <div class="card mb-3">
        <img src="<?php echo e(asset('storage/'.$post->path_to_image)); ?>" class="card-img-top" alt="...">
        <div class="card-body">
...
<?php endif; ?>
<?php /**PATH D:\Coding\Kostki\resources\views/posts/single-post-page.blade.php ENDPATH**/ ?>